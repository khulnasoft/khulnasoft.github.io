...
The `SECURITY.MD` file used by default in new Khulnasoft GitHub repos can be found
in the repo `khulnasoft/repo-templates` at https://github.com/khulnasoft/repo-templates.
...
<!-- BEGIN KHULNASOFT SECURITY.MD V0.0.5 BLOCK -->
...
If you believe you have found a security vulnerability in any Khulnasoft-owned repository that meets [Khulnasoft's definition of a security vulnerability](https://docs.khulnasoft.com/en-us/previous-versions/tn-archive/cc751383(v=technet.10)), please report it to us as described below.
